...
####################################
#1.Display progress logs on stdout
...
###########################################
#3.Load some categories from the training set
...
def benchmark(clf):
  ...
  if hasattr(clf,'coef_'):
    ...
    if opts.print_top10 and feature_names is not None:
      print("top 10keywords per class:")
...
pl.barh(indices + .6,test_time,.2,label="test_time",color='b')
pl.yticks(())
pl.legend(loc='best')
